...
def test_ace_dataanalysis():
    ...
    with allure.step("断言建立分析后能获取统计数据"):
        ...
        stat_channels = [
            {'stat_type': 'mean', 'cmptId': 'Blade 1', 'frameId': 'Blade root axes', 'varId': 'Mx', 'sectId': 'root',
             'unitId': 'N-m'},
            {'stat_type': 'mean', 'cmptId': 'Blade 1', 'frameId': 'Blade root axes', 'varId': 'My', 'sectId': 'root',
             'unitId': 'N-m'},
            {'stat_type': 'mean', 'cmptId': 'Blade 1', 'frameId': 'Blade root axes', 'varId': 'Mxy', 'sectId': 'root',
             'unitId': 'N-m'}
        ]
        ...
        assert set(
            ["dlc", "case_name", "mean_Blade 1_Blade root axes_Mx_root_N-m", "mean_Blade 1_Blade root axes_My_root_N-m",
             "mean_Blade 1_Blade root axes_Mxy_root_N-m"]).issubset(df1.columns)
    ...
    with allure.step("断言获取时序数据"):
        ...
        assert set(
            ["dlc", "case_name", "mean_Blade 1_Blade root axes_Mx_root_N-m", "mean_Blade 1_Blade root axes_My_root_N-m",
             "mean_Blade 1_Blade root axes_Mxy_root_N-m"]).issubset(top5.columns)
